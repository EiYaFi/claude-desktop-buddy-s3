...
> **About this fork**: Adds **M5StickS3 firmware port** and a **Claude Code
> bridge** on top of [upstream
> anthropics/claude-desktop-buddy](https://github.com/anthropics/claude-desktop-buddy).
> One-liner install on a new machine: see **[SETUP.md](SETUP.md)** (Chinese;
> an English version is planned — meanwhile see
> [`tools/claude-code-bridge/README.md`](tools/claude-code-bridge/README.md)
> for the bridge-side setup in English).
...
This fork additionally supports the **M5StickS3** (ESP32-S3-PICO-1-N8R2) —
see [M5StickS3.md](M5StickS3.md) for the port-specific gotchas.
...
tools/           — generators and converters; this fork also ships claude-code-bridge/
```
